  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-[75vh]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        >
          <Plus className="h-4.5 w-4.5 mr-1.5" /> Plan New Trip
        </Link>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="h-44 w-full overflow-hidden relative">
                  ...
                  <div className="absolute top-3 right-3 flex gap-2">
                    <button
                      ...
                      className="bg-white/90 backdrop-blur-xs text-gray-700 hover:text-primary-600 p-2 rounded-full shadow-sm transition-colors"
                    ...
                    <button
                      ...
                      className="bg-white/90 backdrop-blur-xs text-gray-700 hover:text-red-600 p-2 rounded-full shadow-sm transition-colors"
                      title="Delete Trip"
                    >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    {/* Title */}
                    <h3 className="text-xl font-bold text-gray-900 leading-snug line-clamp-1 hover:text-primary-600 transition-colors mb-3">
                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-end">
                  <Link 
                    to={`/trips/${trip.id}`} 
                    className="text-xs font-black text-primary-500 hover:text-primary-600 flex items-center transition-colors animate-pulse-slow"
                  >
